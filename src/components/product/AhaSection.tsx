...
export function AhaSection() {
  return (
    <section className="py-20 sm:py-28 bg-wayo-cream">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        >
          ...
          <p className="text-xl sm:text-2xl text-gray-700 leading-relaxed mb-8 font-medium">
            One second they're right there. The next — you're spinning around in a crowded market, your heart pounding, calling their name.
          </p>
          <p className="text-lg sm:text-xl text-gray-600 leading-relaxed mb-12">
            It happens to every parent. In malls. At weddings. On beaches. At railway stations.
          </p>
          <p className="text-xl sm:text-2xl font-bold text-wayo-dark leading-relaxed mb-12">
            Wayo Band is the invisible safety thread between you and your child — so that moment of panic never has to last more than a second.
          </p>
