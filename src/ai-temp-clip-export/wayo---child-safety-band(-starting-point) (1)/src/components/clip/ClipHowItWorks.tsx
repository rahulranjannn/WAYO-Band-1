    ...
    <section className="py-24 bg-[#FFF8DC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-block bg-wayo-mint/20 text-wayo-mint font-bold px-4 py-1.5 rounded-full text-sm mb-6">
            Simple by Design
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative flex flex-col items-center text-center">
              <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center text-3xl font-extrabold text-wayo-dark shadow-sm border-4 border-[#FFF8DC] z-10 mb-6">
                {step.number}
              </div>
