          ...
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr>
                ...
                <th className="p-4 sm:p-6 w-[18%] text-center text-xl font-bold text-wayo-dark bg-wayo-cream rounded-t-2xl">Wayo Clip <Check className="inline w-5 h-5 text-green-500" strokeWidth={3}/></th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
              <tr>
                ...
                <td className="p-4 sm:p-6 text-center text-xl">❌</td>
                <td className="p-4 sm:p-6 text-center bg-wayo-cream text-green-600 font-bold">✅ Instant</td>
              </tr>
              <tr>
                ...
                <td className="p-4 sm:p-6 text-center text-xl">❌</td>
                <td className="p-4 sm:p-6 text-center text-xl">✅</td>
                <td className="p-4 sm:p-6 text-center bg-wayo-cream text-xl">✅</td>
              </tr>
              <tr>
                ...
                <td className="p-4 sm:p-6 text-center text-xl">❌</td>
                <td className="p-4 sm:p-6 text-center bg-wayo-cream text-wayo-dark font-bold">Zero. Forever.</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="p-4 sm:p-6 text-center text-wayo-dark font-bold text-xl bg-wayo-cream rounded-b-2xl border-b-0">₹799 once</td>
              </tr>
            </tbody>
          </table>
        </div>
