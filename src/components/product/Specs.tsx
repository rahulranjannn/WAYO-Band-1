  ...
  return (
    <section className="py-16 sm:py-24 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-wayo-cream border-2 border-white rounded-[2rem] p-6 sm:p-10 shadow-sm">
          <div className="flex flex-col">
            {details.map((detail, index) => (
              <div
                key={index}
                className={`flex flex-col sm:flex-row sm:items-center justify-between py-6 gap-2 sm:gap-4 ${index !== details.length - 1 ? 'border-b border-gray-200' : ''
                  }`}
              >
