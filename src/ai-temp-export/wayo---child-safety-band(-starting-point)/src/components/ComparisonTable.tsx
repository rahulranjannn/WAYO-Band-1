          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr>
                ...
                <th className="p-3 sm:p-6 w-[30%] sm:w-1/4 text-center text-base sm:text-xl font-bold text-wayo-coral bg-[#FFF9F5] rounded-t-2xl sm:rounded-t-3xl leading-tight">
            ...
            <tbody className="divide-y divide-gray-100">
              <tr>
                ...
                <td className="p-3 sm:p-6 text-center bg-[#FFF9F5]"><Check className="w-5 h-5 sm:w-6 sm:h-6 text-green-500 mx-auto" strokeWidth={3} /></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="p-3 sm:p-6 text-center text-wayo-coral font-bold text-lg sm:text-2xl bg-[#FFF9F5] rounded-b-2xl sm:rounded-b-3xl border-b-0">₹1,499</td>
              </tr>
            </tbody>
          </table>
        </div>
